...
export const BRANDS: Brand[] = [
  ...
  { id: 'unc-nic', name: 'UNC 5%', tagline: 'Pure tobacco leaf extraction', puffRange: '5000 Puffs', description: 'Focused on authentic tobacco and straightforward blends.', image: 'https://placehold.co/600x600/1a1a1a/D4AF37?text=UNC+5%25', category: 'disposable-vapes' },
  { id: 'unc-nonic', name: 'UNC 0%', tagline: 'Zero nicotine, full flavor', puffRange: '5000 Puffs', description: 'The perfect choice for those who want the sensation without the nicotine.', image: 'https://placehold.co/600x600/1a1a1a/D4AF37?text=UNC+0%25', category: 'disposable-vapes' },
