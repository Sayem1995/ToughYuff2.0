...
export const BRANDS: Brand[] = [
  ...
  { id: 'unc-nic', name: 'UNC 5%', tagline: 'Pure tobacco leaf extraction', puffRange: '5000 Puffs', description: 'Focused on authentic tobacco and straightforward blends.' },
  { id: 'unc-nonic', name: 'UNC 0%', tagline: 'Zero nicotine, full flavor', puffRange: '5000 Puffs', description: 'The perfect choice for those who want the sensation without the nicotine.' },
  { id: 'lava-plus', name: 'Lava Plus', tagline: 'Bold flavors in a compact design', puffRange: '2600 Puffs', description: 'A reliable choice with a vast array of intense fruit and dessert profiles.' },
...
const RAW_PRODUCT_DATA = [
  // Cali 8k
  { brandId: 'cali-ul8000', name: 'Blue Raspberry Lemonade', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Apple Watermelon', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Blackberry', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Blue Raspberry', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Grape', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Lush', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Peach', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Strawberry Raspberry', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Banana', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Kiwi Lemonade', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Frozen Watermelon', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Mighty Mint', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Mexican Mint', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'LA Mint', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Peach Watermelon', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Peach Mango Watermelon', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Pineapple Splash', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Pineapple Strawberry Banana', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Strawberry Banana', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Strawberry Kiwi', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Triple Berry', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Watermelon Splash', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Kiwi Dragon Berry', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Spearmint', code: '(C8K)' },
  { brandId: 'cali-ul8000', name: 'Polar Ice', code: '(C8K)' },
