...
const RAW_PRODUCT_DATA = [
  ...
  // Boutiq Switches
  { brandId: 'boutique-switch', name: 'Arctic Frost\nRocket Pop\nTropic Haze', code: '(BS)', strains: ['Hybrid', 'Hybrid', 'Sativa'] },
  { brandId: 'boutique-switch', name: 'Baja Berry\nX-41\nDaydream', code: '(BS)', strains: ['Hybrid', 'Hybrid', 'Indica'] },
  { brandId: 'boutique-switch', name: 'Blinker Berry\nPluto\nBlue Mango', code: '(BS)', strains: ['Indica', 'Indica', 'Indica'] },
  { brandId: 'boutique-switch', name: 'Blue Matcha\nAcai Berry\nSour Slush', code: '(BS)', strains: ['Sativa', 'Sativa', 'Sativa'] },
  { brandId: 'boutique-switch', name: 'Cherry Gelato\nFruit Stripe\nStraw-Tangie', code: '(BS)', strains: ['Hybrid', 'Hybrid', 'Sativa'] },
  { brandId: 'boutique-switch', name: 'Cherry Lime\nCrunch Berry\nOrange Mochi', code: '(BS)', strains: ['Sativa', 'Indica', 'Hybrid'] },
  { brandId: 'boutique-switch', name: 'Grape Soda\nGlowberry\nCherry Pie', code: '(BS)', strains: ['Indica', 'Indica', 'Indica'] },
  { brandId: 'boutique-switch', name: 'Grape-Ape\nJelly Roll\nRainbow Belts', code: '(BS)', strains: ['Indica', 'Indica', 'Indica'] },
  { brandId: 'boutique-switch', name: 'Italian Ice\nLemon Cherry\nZ-Runtz', code: '(BS)', strains: ['Hybrid', 'Hybrid', 'Indica'] },
  { brandId: 'boutique-switch', name: 'Lemon Stripes\nOZK\nMango Kush', code: '(BS)', strains: ['Sativa', 'Indica', 'Hybrid'] },
  { brandId: 'boutique-switch', name: 'Lime Haze\nSlimeade\nStarfruit', code: '(BS)', strains: ['Sativa', 'Indica', 'Hybrid'] },
  { brandId: 'boutique-switch', name: 'Maui Wowie\nGelato41\nMango Melon', code: '(BS)', strains: ['Sativa', 'Hybrid', 'Indica'] },
  { brandId: 'boutique-switch', name: 'Mojito\nKiwi-Z\nLime Slush', code: '(BS)', strains: ['Sativa', 'Hybrid', 'Indica'] },
  { brandId: 'boutique-switch', name: 'Orange Slush\nMango Runtz\nGuava Gelato', code: '(BS)', strains: ['Sativa', 'Indica', 'Hybrid'] },
  { brandId: 'boutique-switch', name: 'Peach Kush\nMango Berry\nYellow Diesel', code: '(BS)', strains: ['Hybrid', 'Indica', 'Sativa'] },
  { brandId: 'boutique-switch', name: 'Pink Haze\nCandyland\nStraw-Haze', code: '(BS)', strains: ['Sativa', 'Sativa', 'Sativa'] },
  { brandId: 'boutique-switch', name: 'Pink Z\nDragonfruit\nTropicana', code: '(BS)', strains: ['Indica', 'Hybrid', 'Sativa'] },
  { brandId: 'boutique-switch', name: 'Purple Papaya\nBlue Berriez\nRZ-11', code: '(BS)', strains: ['Indica', 'Indica', 'Indica'] },
