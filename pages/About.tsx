          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-surface p-6 rounded-xl border border-black/5 shadow-sm">
                ...
                <h3 className="font-bold text-text-primary mb-2">Multi-Brand Catalog</h3>
              ...
              <div className="bg-surface p-6 rounded-xl border border-black/5 shadow-sm">
                ...
                <h3 className="font-bold text-text-primary mb-2">Zero Nicotine Options</h3>
                <p className="text-sm text-text-tertiary">A dedicated selection for those reducing their nicotine intake.</p>
              </div>
              <div className="bg-surface p-6 rounded-xl border border-black/5 md:col-span-2 shadow-sm">
                <ShieldCheck className="text-gold mb-4 w-8 h-8" />
                <h3 className="font-bold text-text-primary mb-2">21+ Compliance</h3>
