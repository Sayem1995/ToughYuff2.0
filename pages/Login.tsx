    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-surface relative items-center justify-center p-12 border-r border-black/5">
        ...
        <div className="relative z-10 text-center">
          <div className="w-64 h-80 mx-auto bg-background/50 backdrop-blur-sm border border-black/5 rounded-2xl mb-8 flex items-center justify-center shadow-sm overflow-hidden p-6">
            <img src="/logo.png?v=3" alt="ToughYuff Logo" className="w-full h-auto object-contain drop-shadow-xl" />
          </div>
